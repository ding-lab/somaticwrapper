...
my $bam_rc="/gscmnt/gc2525/dinglab/rmashl/Software/bin/bam-readcount/0.7.4/bam-readcount";
...
my $genomevip="/gscmnt/gc2525/dinglab/rmashl/Software/bin/genomevip"; 

## database and tool for annotation ##
  ...
  #	print VARSCAN "#BSUB -w \"$hold_job_file\"","\n";
   #   print VARSCAN "#BSUB -q long\n";
    ...
    print VARSCAN "CONFDIR="."/gscmnt/gc2521/dinglab/cptac_prospective_samples/exome/config\n";
   	print VARSCAN "GENOMEVIP_SCRIPTS=$genomevip\n";
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/genomevip\n";
...
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/samtools/1.2/bin\n";
...
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/snpEff/20150522/SnpSift.jar\n";
    print STREKAP "streka.dbsnp.snv.db = $db_gl\n";  
#/gscmnt/gc3027/dinglab/medseq/cosmic/00-All.brief.pass.cosmic.vcf\n";
...
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/snpEff/20150522/SnpSift.jar\n";
    print STREKAP "streka.dbsnp.indel.db = $db_gl\n"; 
#/gscmnt/gc3027/dinglab/medseq/cosmic/00-All.brief.pass.cosmic.vcf\n";
	...
	print STREKAP "strelka.fpfilter.snv.bam_readcount = $bam_rc\n"; 
...
#/gscmnt/gc3027/dinglab/medseq/cosmic/00-All.brief.pass.cosmic.vcf\n";
	...
	print VARSCANP "varscan.fpfilter.snv.bam_readcount = $bam_rc\n"; 
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/bam-readcount/0.7.4/bam-readcount\n";
...
#	print VARSCANP "varscan.vep.vep_cmd = $vepcmd\n";
#/gscmnt/gc2525/dinglab/rmashl/Software/bin/VEP/v81/ensembl-tools-release-81/scripts/variant_effect_predictor/variant_effect_predictor.pl\n";
#	print VARSCANP "varscan.vep.cachedir = $vepcache\n";
# /gscmnt/gc2525/dinglab/rmashl/Software/bin/VEP/v81/cache\n";
