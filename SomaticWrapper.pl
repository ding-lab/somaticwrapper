...
if (($step_number eq '1') || ($step_number eq 'run_strelka')) {
    ...
    parse_strelka($results_dir, $job_files_dir, $filter_dir, $strelka_snv_raw, $strelka_vcf_filter_config);
    ...
    parse_varscan_snv($results_dir, $job_files_dir, $filter_dir, $varscan_jar, $varscan_indel_raw, $varscan_snv_raw, $varscan_config, $varscan_vcf_filter_config);
    ...
    parse_pindel($results_dir, $job_files_dir, $reference_fasta, $perl, $gvip_dir, $filter_dir, $pindel_dir, $pindel_config, $pindel_raw, $no_delete_temp, $pindel_vcf_filter_config, $bypass);
