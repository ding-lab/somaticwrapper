...
if (($step_number eq '1') || ($step_number eq 'run_strelka')) {
    ...
    die("reference_fasta undefined \n") unless $reference_fasta;
    parse_pindel($results_dir, $job_files_dir, $reference_fasta, $perl, $gvip_dir, $pindel_dir, $pindel_config, $pindel_raw, $no_delete_temp, $bypass_cvs, $bypass_homopolymer, $debug);
    ...
    vep_annotate($results_dir, $job_files_dir, $reference_fasta, $gvip_dir, $filter_dir, $vep_cmd, $assembly, $vep_cache_version, $vep_cache_dir, $vep_cache_gz, $preserve_cache_gz, $input_vcf, $af_filter_config, $classification_filter_config, $bypass_af, $bypass_classification, $debug)
    ...
    vaf_length_depth_filters($results_dir, $job_files_dir, $filter_dir, $input_vcf, $output_vcf, $caller, $vcf_filter_config, $bypass_vaf, $bypass_length, $bypass_depth, $debug);
