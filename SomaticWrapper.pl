...
if (($step_number eq '1') || ($step_number eq 'run_strelka')) {
    ...
    die("strelka_config undefined \n") unless $strelka_config;
    parse_strelka($results_dir, $job_files_dir, $filter_dir, $strelka_snv_raw);
    ...
    die("varscan_config undefined \n") unless $varscan_config;
    parse_varscan_snv($results_dir, $job_files_dir, $filter_dir, $varscan_jar, $varscan_indel_raw, $varscan_snv_raw, $varscan_config);

} elsif (($step_number eq '4b') || ($step_number eq 'parse_varscan_indel')) {
    die("Varscan Indel Raw input file not specified \n") unless $varscan_indel_raw;
    die("varscan_config undefined \n") unless $varscan_config;
    parse_varscan_indel($results_dir, $job_files_dir, $filter_dir, $varscan_jar, $varscan_indel_raw, $varscan_config);
    ...
    die("reference_fasta undefined \n") unless $reference_fasta;
    parse_pindel($results_dir, $job_files_dir, $reference_fasta, $perl, $gvip_dir, $filter_dir, $pindel_dir, $pindel_config, $pindel_raw, $no_delete_temp, $bypass_cvs, $bypass_homopolymer);
    ...
    die("reference_fasta undefined \n") unless $reference_fasta;
    merge_vcf($results_dir, $job_files_dir, $filter_dir, $reference_fasta, $gatk_jar, $strelka_snv_vcf, $varscan_indel_vcf, $varscan_snv_vcf, $pindel_vcf, $bypass_merge);
    ...
    vep_annotate($results_dir, $job_files_dir, $reference_fasta, $gvip_dir, $filter_dir, $vep_cmd, $assembly, $vep_cache_version, $vep_cache_dir, $vep_cache_gz, $preserve_cache_gz, $input_vcf, $af_filter_config, $classification_filter_config, $bypass_af, $bypass_classification)
    ...
    die("input_vcf undefined \n") unless $input_vcf;
    dbsnp_filter($results_dir, $job_files_dir, $perl, $gvip_dir, $dbsnp_db, $snpsift_jar, $input_vcf, $bypass_dbsnp);
    ...
    vaf_length_depth_filters($results_dir, $job_files_dir, $filter_dir, $input_vcf, $output_vcf, $caller, $vcf_filter_config, $bypass_vaf, $bypass_length, $bypass_depth);
